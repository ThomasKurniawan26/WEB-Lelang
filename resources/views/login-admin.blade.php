...
<body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    ...
    <div id="loading">
        <div class="loader simple-loader">
            <div class="loader-body"style="background-image:url('/Assets/assets/img/lelang-logo.png'); background-repeat:no-repeat; background-position:center;"></div>
        </div>
    </div>
    <!-- loader END -->
                        ...
                        <div class="col-md-10">
                            <div class="card card-transparent card-shadow d-flex justify-content-center mb-0 auth-card">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{ url('/administrator/proses') }}">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-12">
                                        ...
                                        <div class="row d-flex justify-content-start mb-3">
                                            <div class="col-5">
                                                ...
                                                <input type="radio" value="petugas" class="form-check-input" name="role"
                                                    id="petugas">
                                            </div>
                                            <div class="col-5">
                                                <label for="admin">Admin</label>
                                                <input type="radio" value="administrator" class="form-check-input"
                                                    name="role" id="admin">
                                            </div>
                                        </div>
